...
const plans = [
    {
        ...
        name: "Free",
        price: "$0",
        stripeId: null, // El gratis no requiere Stripe
    ...
    },
    {
        ...
        name: "Pro",
        price: "$29",
        stripeId: "price_1TZycqK3K372cnXt4LnBmpVk", // ⚡ Reemplaza con tu ID de Stripe (pk_test...)
    ...
    },
    {
        ...
        name: "Business",
        price: "$99",
        stripeId: "price_1TZyfGK3K372cnXtjYfkFhgG", // ⚡ Reemplaza con tu ID de Stripe (pk_test...)
